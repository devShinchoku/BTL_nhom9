    ...
    <main class="container">
        <div class="row">
            ...
            <div class="col-md-8" style="padding: 0 24px;background-color: #FAFAFB;">
                                ...
                                <div class="lh-5-phone-number-cont">
                                    <div class="ma-quoc-gia">
                                        ...
                                        <div class="container-phone-number">
                                            <form id="login-phone-number" onsubmit="process(event)">
                            ...
                            <div class="person-sl-1" style="padding: 16px 16px 0px 16px; display: flex;">
                                <div class="adult-sl">
                                    ...
                                    <div class="tab-sl">
                                        <div class="dash-tab-1" style="display: flex;">
                                            <div id="minus1" class="dash-tab" style="padding: 4px;">
                                                <button class="dash-sl minus" style="padding: 1px;">
                                                    <i class="bi bi-dash-circle"></i>
                                                </button>
                                            </div>
                                                <input id="qty1" class="text-sl-person qty" type="text" style="border: none;" value="1" readonly>
                                            <div class="dash-tab" style="padding: 4px;">
                                                <button id="add1" class="plus-sl add">
                                ...
                                <div class="adult-sl">
                                    ...
                                    <div class="tab-sl">
                                        <div class="dash-tab-1" style="display: flex;">
                                            <div class="dash-tab" style="padding: 4px;">
                                                <button class="dash-sl" style="padding: 1px;">
                                                    <i class="bi bi-dash-circle"></i>
                                                </button>
                                            </div>
                                                <input class="text-sl-person" type="text" style="border: none;" value="0" readonly>
                                            <div class="dash-tab" style="padding: 4px;">
                                                <button class="plus-sl">
                                                    <i class="bi bi-plus-circle"></i>
                                                </button>
                                            </div>
                                        </div>
                ...
                <div class="formInput adult-info card" style="padding: 8px; margin-bottom: 16px;">
                ...
                <div class="bonus-dv card" style="padding: 8px; margin-bottom: 16px;">
                    <div class="bonus-dv-0">
                        ...
                        <div class="bonus-dv-4">
                            <div class="bonus-dv-6" style="padding: 12px 12px 0px 12px; display: flex; align-items: center;">
                    ...
                    <div class="info-abate-1" style="padding: 16px;">
                        ...
                        <div class="bonus-dv-2" style="padding-left: 8px;">
                            <div class="bonus-dv-3" style="display: flex; padding: 8px;">
                                <input type="checkbox" style="height: 22px; width: 40px;">
