...
<body>
  ...
  <div>
    <div class="container mt-5 p-2" style="margin-top: 7rem!important;">
      <form>
        <b class="mt-4" style="font-size: 18px;color: royalblue;">
          Thông tin tour
        </b>
        ...
        <div class="row">
          <div class="col-md-9">
            <div style="display: flex;">
              <div class="col-md-6">
                <div class="form-group mt-3">
                  <label for="fullname" class="form-lable">Tên Tour</label>
                  <input type="text" id="fullname" name="fullname" placeholder="Nhập tên tour" type="text">
                  <span class="form-message"></span>
                </div>
                <div class="form-group mt-3">
                  <label for="fullname" class="form-lable">Số ngày đi Tour</label>
                  <input id="fullname" name="fullname" placeholder="Nhập tổng số ngày di tour" type="text">
                  <span class="form-message"></span>
                </div>
                <div class="form-group mt-3 mb-3">
                  <label for="fullname" class="form-lable">Hạn chót đặt tour (Số ngày)</label>
                  <input id="fullname" name="fullname" placeholder="Nhập tổng số ngày được phép đặt tour" type="text">
                  <span class="form-message"></span>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group mt-3">
                  <label for="fullname" class="form-lable">Mã lưu kho</label>
                  <input id="fullname" name="fullname" placeholder="Nhập mã lưu kho" type="text">
                  <span class="form-message"></span>
                </div>
                <div class="form-group mt-3">
                  <label for="fullname" class="form-lable">Giá cơ bản</label>
                  <input id="fullname" name="fullname" placeholder="0 ₫" type="text">
                  <span class="form-message"></span>
                </div>
                <div style="display: flex; margin-top: 40px;">
                  <div class="inputdecor1 col-md-6">
                    <input type="checkbox" name="search7" id="search7">
                    <label for="search7" class="lable-name"></label>
                        Tour quốc tế
                    </label>
                  </div>
                  <div class="inputdecor1 col-md-6">
            ...
            <div style="display: flex;">
              <div class="col-md-6">
                <div class="form-group mt-2">
                  <label for="fullname" class="form-lable">Địa chỉ</label>
                  <input id="fullname" name="fullname" placeholder="Nhập địa chỉ" type="text">
                  <span class="form-message"></span>
                </div>
                <div class="form-group mt-3 mb-3">
                  <label for="fullname" class="form-lable">Thành phố</label>
                  <input id="fullname" name="fullname" placeholder="Nhập thành phố" type="text">
                  <span class="form-message"></span>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group mt-2 mb-3">
                  <label for="fullname" class="form-lable">Quận/Huyện</label>
                  <input id="fullname" name="fullname" placeholder="Nhập quận/Huyện" type="text">
                  <span class="form-message"></span>
                </div>
                <div class="form-group mt-2 mb-3">
                  <label for="fullname" class="form-lable">Khuyến mãi</label>
                  <input id="fullname" name="fullname" placeholder="Nhập khuyến mãi" type="text">
                  <span class="form-message"></span>
                </div>
              </div>
            </div>
            ...
            <div class="mt-2">
              ...
              <textarea class="tour-descript" name="" id="" cols="" rows=""></textarea>
            </div>
            <hr style="width: 80%;">
            <div class="mt-2">
              <div>
          ...
          <div class="col-md-3">
            <div class="container">
              <div class="card tourpage-img">
                <label class="tourpage-img-title mt-2" for="">Logo</label>
                <input  class="tourpage-btn" type="file" accept="image/png, image/jpeg">
              </div>
              <div class="card tourpage-img mt-3">
                <label class="tourpage-img-title mt-2" for="">Ảnh thư viện</label>
                <div style="text-align: center;">
                  <input type="file" accept="image/png, image/jpeg" class="tourpage-btn">
                </div>
