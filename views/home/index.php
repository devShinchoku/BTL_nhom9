<?php
require_once("views/home/template/header.php");
?>
...
<script src="http://localhost/mvc/assets/js/lazyload.js"></script>
<script src="http://localhost/mvc/assets/js/weather.js"></script>
<?php
require_once("views/home/template/footer.php");
?>